...
`agym` provides an integrated statusline for Antigravity that renders the active account name, active model, live quota, and context window usage at all times at the bottom of the terminal:
